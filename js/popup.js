function socialShare(event,type){
	...
	var link = "http://ncase.me/matrix";
	var title = "THE MAGNIFICENT 2D MATRIX";
	var desc = "Behold the beast! Play with an interactive 2d matrix.";
	var url = "";
	var width = 640;
	var height = 480;
	...
	switch(type){
		...
		case "tumblr":
			...
			break;
		case "reddit":
			window.open('http://www.reddit.com/submit?v=5&amp;noui&amp;jump=close&amp;url='+encodeURIComponent(link)+'&amp;title='+encodeURIComponent(title), "reddit",'toolbar=no,width=700,height=550');
			return false;
			break;
		case "stumbleupon":
